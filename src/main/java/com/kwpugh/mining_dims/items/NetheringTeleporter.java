...
public class NetheringTeleporter extends BaseTeleporter {
    private static final ResourceKey<Level> DIM_KEY = MiningDimsRegistry.MININGDIMS_WORLD_KEY4;

    public NetheringTeleporter(Properties properties) {
        super(properties);
    }
